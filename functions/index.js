...
const { loescheAlle, loescheZugangscodesMitBildern, loeschUmfang, loescheKontoHart,
        gehoertNochDemKonto, repariereFehlendeAblaufdaten,
        loescheAlteAnonymeKonten } = require('./loeschen');
...
exports.taeglichesAufraeumen = onSchedule(
  ...
  async () => {
    ...
    // 4) Anonyme Sitzungen des Schueler-Portals. Jeder Portalbesuch legt ein
    // Anmeldekonto an; bisher wurde nie eines entfernt. 60 Tage ohne jede
    // Aktivitaet - geprueft wird die letzte Anmeldung, nicht das Anlegedatum,
